...
func TestMatchesAll_CurlSimple(t *testing.T) {
	...
	got := MatchesAll("Bash", bashInput("curl https://example.com"), rules).Matched
	if !got {
...
func TestMatchesAll_CurlWithPipe(t *testing.T) {
	...
	got := MatchesAll("Bash", bashInput(cmd), rules).Matched
	if !got {
...
func TestUnmatchedCommands(t *testing.T) {
	...
	got := MatchesAll("Bash", input, rules).UnmatchedCommands
...
func TestMatchesAll_EmptyCommand(t *testing.T) {
	...
	got := MatchesAll("Bash", bashInput(""), rules).Matched
	if got {
...
func TestMatchesAll_Synonyms(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			got := MatchesAll("Bash", bashInput(tc.cmd), tc.rules).Matched
			if got != tc.want {
...
func TestDenyBeforeAllow(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			allowed := MatchesAll("Bash", input, allow).Matched
...
func TestMatchesAll_EnvAssignments(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			if got := MatchesAll("Bash", bashInput(tc.cmd), tc.rules).Matched; got != tc.want {
...
func TestMatchesAll_MonitorAllowedByBashRules(t *testing.T) {
	...
	got := MatchesAll("Monitor", monitorInput("tail -f app.log | grep --line-buffered ERROR"), rules).Matched
	if !got {
...
func TestMatchesAll_MonitorPartial(t *testing.T) {
	...
	got := MatchesAll("Monitor", monitorInput("tail -f app.log | grep ERROR"), rules).Matched
	if got {
...
func TestMatchesAll_MonitorLoopWithSubshell(t *testing.T) {
	...
	got := MatchesAll("Monitor", monitorInput(cmd), rules).Matched
	if !got {
...
func TestMatchesAll_MonitorWebSocketVariant(t *testing.T) {
	...
	if MatchesAll("Monitor", b, rules).Matched {
...
func TestMatchesAll_BashNotGovernedByMonitorRules(t *testing.T) {
	...
	if MatchesAll("Bash", bashInput("rm -rf /tmp/x"), rules).Matched {
