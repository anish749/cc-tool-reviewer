---
name: release
description: Tag a new patch release, wait for the GitHub Actions release workflow to succeed, then install the binary locally via install.sh.
...
5. **Confirm**: Print the installed version.
